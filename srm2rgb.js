...
(function(window) {
  ...
  // Continent Colors
  SRM_TO_RGB['americas']     = 'rgb(237, 51, 78)';
  SRM_TO_RGB['europe']       = 'rgb(8,133,194)';
  SRM_TO_RGB['africa']       = 'rgb(0,0,0)';
  SRM_TO_RGB['asia']         = 'rgb(251,162,9)';
  SRM_TO_RGB['australia']    = 'rgb(28,139,60)';
  ...
  window.srm2rgb = function (continent) {
    ...
    //console.log(rounded);
    return SRM_TO_RGB[continent] || 'rgb(255, 0, 255)';
